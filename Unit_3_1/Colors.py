...
for line in data[1:]:
    ...
    everything = [time_list, Red_list, Green_list, Blue_list]


# plt.plot(time_list, Red_list, color='r' )
...
axs[0].set_ylabel('Light Lenght (in nm)')

# fig.xlabel('time (in Seconds)')
# axs[0].ylabel('Light Lenght (in nm)')
axs[1].plot(4, 20, time_list, Green_list, color= 'g')
axs[1].grid()
axs[1].axis([0,40,0,60])

axs[1].set_ylabel('Light Lenght (in nm)')
...
axs[2].set_ylabel('Light Lenght (in nm)')
